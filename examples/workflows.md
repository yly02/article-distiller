...
一分钟速览固定 3 条，内容跟体裁走；单产品是它是什么 / 多了哪一步 / 怎么用，同源套件、发布会、论文、官方研究报告、商业动态见体裁表
...
事件、产品、论文、调查和机制解释应选择不同的章节原型。同源套件仍用单产品原型，官方研究报告用论文原型，不要另开技术前沿。每一节必须增加新事实、新区别、新机制或新后果；如果删掉一节不影响中心论证，这一节就不该存在。
