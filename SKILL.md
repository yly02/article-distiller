...
写作标准是：真材实料为底，原文要点为骨，白话为形。写作引擎只有一套，细则以 [references/article-depth.md](references/article-depth.md) 为准：标题是主体加材料支持的人话结果，必须吸引人、有冲击力；一句导语加三条速览；一节对应原文一项要点；语气和骨架跟着原文体裁走。单产品按能力，发布会先全景后深挖，论文用日期或对照数字开场，商业动态短写机制。同源套件仍按单产品，官方研究报告并进论文，多口径速度数字拆开；不要把分析稿、方法稿写成产品能力清单，也不要把发布会或论文改成速查表。
...
- 只交付深度文章 HTML。
- 不能基于空正文或明显残篇写作。
- 标题先放高认知主体，再放材料支持的人话结果、动作或完整口径数字，必须吸引人、有冲击力。面向 B 端时，标题要让老板愿意点开，点出周报、复盘、汇报这类日常工作，不空喊改变社会。冲击力来自反差、反常结果、具体动作或可核验规格，不要写成正确但没画面的过程句，也不要单独写推荐理由。一分钟速览固定 3 条：这是 AI 的哪类应用、好用在日常哪一步、改了工作里哪一件事；文末不渲染打勾清单。
