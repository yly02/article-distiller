...
写作标准是：真材实料为底，原文要点为骨，白话为形。写作引擎只有一套，细则以 [references/article-depth.md](references/article-depth.md) 为准：标题是主体加材料支持的人话结果；一句导语加三条速览；一节对应原文一项要点；语气和骨架跟着原文体裁走。单产品按能力，发布会先全景后深挖，论文先对齐口径，商业动态短写机制。同源套件仍按单产品，官方研究报告并进论文，多口径速度数字拆开；不要把分析稿、方法稿写成产品能力清单，也不要把发布会或论文改成速查表。
...
3. 先判断体裁并列出原文要点清单，再写成白话章节。一节只讲一项要点：单产品节点名演示，发布会先全景后逐台深挖，论文节写清样本和指标，分析节讲清原文划界，方法节写清步骤和闸门，商业动态写清机制和两边评价。同源套件按任务难度拆，不要改成发布会；官方研究报告先写官方定义；推理时延、墙钟和吞吐不是同一个“快”。不要为了“独特见解”把原文重写成另一篇文章。原文有的能力、框架、演示、数字、工具和限制默认都要覆盖；只有重复装饰或与要点无关时才能省略，并写明理由。材料足够时优先搭出 5-8 个有独立任务的章节。要点讲完再写读者能带走的一步；安全与口径短写，演示、框架和步骤写够。
...
- 语气跟着原文体裁：单产品和研究用说明文，发布会先全景，论文先对齐口径，分析用原文框架，方法用步骤和闸门，商业动态短写机制，危机散文才跟文学腔。同源套件仍按单产品，官方研究报告并进论文/临床，对标站栏目名不当写作体裁。不把对标站的标题腔、长提示词模板、会员栏或没看见的演示细节写进正文。发散只补官方文档、已看见的演示、参数、定价和原文自带的方法骨架。
